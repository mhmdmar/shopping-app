            ...
            <div>
                ...
                <p>
                    ...
                    <span class="highlight preview_website_url">
                        <a :href="webSiteName">here</a> </span
                    >.
                </p>
                <p>
                ...
                <p>
                    ...
                    a non-exclusive license to use, reproduce, edit and
                ...
                <p>
                    ...
                    >'s logo or other artwork will be allowed for linking absent
                ...
                <p>
                    All credit to this terms and conditions content goes to
...
<script>
    export default {
        ...
        data() {
            return {
                appName: "The Shopping Cart",
                webSiteName: "https://www.MuhammadShoppingCart.com",
                companyName: "Mohe Land"
            };
        }
    };
</script>
